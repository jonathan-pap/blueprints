...
- This is **not** the filter pane. Filter pane styling (`outspacePane`, `filterCard`) is applied via report-level theme properties, not via `visualStyles`. See `../../../report/filters/configure-filter-pane.md` and `../../where-themes-live.md`.
