...
- `labels.md` — `objects.labels` anatomy + the `showSeries: false` carrier trap (dynamic labels silently suppressed)
- `visual-presets.md` — one-shot style bundles (minimal/clean/bold/emphasis/presentation)

## Rule

If you're about to override the same property on more than 2 visuals of the same type, stop. That's a theme change. Escalate to `override-property.md` (sub-room).
