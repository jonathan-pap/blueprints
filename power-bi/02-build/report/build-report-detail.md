# Build a report — step detail

> The **sequence** is [`build-report.md`](build-report.md) (read that every build). This file is the
> elaboration per step — load a section only when the one-liner isn't enough.
