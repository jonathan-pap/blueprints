...
PROVIDER = {
    ...
    # long-form names that swamp a Top-5 bar list (added 2026-08-17 after the
    # first full pull surfaced them; see shorten_operators note in brief 2b)
    'Army Ballistic Missile Agency': 'ABMA',
    'China Aerospace Corporation': 'China Aerospace',
    'Eurockot Launch Services': 'Eurockot',
    'Institute of Space and Astronautical Science': 'ISAS',
    'International Launch Services': 'ILS',
    'Interstellar Technologies': 'Interstellar Tech',
    ...
    'Lockheed Martin Space Operations': 'LM Space Ops',
    'Lockheed Space Operations Company': 'Lockheed Space Ops',
    'Ministry of Aerospace Industry': 'Aerospace Ministry',
    'Ministry of Space Industry': 'Space Ministry',
    'National Center of Space Research': 'CNES',
    'National Space Development Agency of Japan': 'NASDA',
    'Northrop Grumman Space Systems': 'Northrop Space Sys',
    'Production Corporation Polyot': 'Polyot',
    'Progress Rocket Space Center': 'Progress RSC',
    'Rockwell International': 'Rockwell',
    'Russian Aerospace Defence Forces': 'RU Aerospace Forces',
    'Science and Engineering Research Council': 'SERC',
    'Seventh Ministry of Machine Building Industry': '7th Ministry (PRC)',
    'United Space Alliance': 'Utd Space Alliance',
}
