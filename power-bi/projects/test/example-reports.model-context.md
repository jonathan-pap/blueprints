...
> Generated from the on-disk TMDL at `example reports.SemanticModel/` on 2026-08-12. A map of the model
> so an agent can work against **real object names** without introspecting it live. Follows the template
> at [`../../../../briefs/model-context-brief.md`](../../../../briefs/model-context-brief.md).
